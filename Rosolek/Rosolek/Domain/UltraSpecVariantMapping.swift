...
struct UltraSpecRequestBuilder {
    ...
    static func mapIngredientID(_ id: String) -> String {
        ...
        case "skrzydla_kaczki": return "POULTRY_WINGS"
        case "szponder": return "BEEF_SHORT_RIB"
        case "prega": return "BEEF_SHANK"
        case "ogon", "ogon_wolowy": return "BEEF_OXTAIL"
        case "kosci_rosolowe": return "BEEF_JOINT_BONES"
        case "kosci_szpikowe": return "BEEF_MARROW_BONES"
        case "mostek": return "BEEF_BRISKET"
        case "golen": return "BEEF_SHANK"
