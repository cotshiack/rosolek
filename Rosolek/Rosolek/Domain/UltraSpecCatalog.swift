...
enum UltraSpecCatalog {
    static let variants: [UltraSpecVariantConfig] = [
        ...
        .init(id: .rosolBogaty, displayName: "Rosół Bogaty", waterFactor: 2.6, vegPercent: 0.140, yieldFactor: 0.80, saltStartCoef: 1.7, saltTargetCoef: 7.7, pepperPerL: 3.5, allspicePerL: 1.3, bayPerL: 0.6, temperature: .init(minC: 88, maxC: 90, allowsBoiling: false), totalMinutes: 350),
